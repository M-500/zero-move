...
type OrderClient interface {
	Create(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateResponse, error)
...
func (c *orderClient) Create(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
...
type OrderServer interface {
	Create(context.Context, *CreateOrderRequest) (*CreateResponse, error)
...
func (UnimplementedOrderServer) Create(context.Context, *CreateOrderRequest) (*CreateResponse, error) {
